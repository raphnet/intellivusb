...
# This Revision: $Id: Makefile,v 1.1 2008-03-01 14:39:10 raph Exp $
...
OBJECTS = usbdrv/usbdrv.o usbdrv/usbdrvasm.o usbdrv/oddebug.o main.o intellivision.o devdesc.o
...
# file targets:
main.bin:	$(COMMON_OBJS) intellivision.o devdesc.o 
